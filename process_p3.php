...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO p_3 (student_name, math, english, sst, science, total, average) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        ...
        echo '<br><button onclick="window.location.href=\'P.3_Marks_ List\'">View Marks List</button>';
    } else {
