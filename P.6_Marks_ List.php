...
<table>
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM p_6 ORDER BY average DESC";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='action-buttons'>
                            <a href='delet_p_6.php?id={$row['id']}' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                            <a href='Updatep_6_form.php?id={$row['id']}'>Update</a>
                        </td>
                      </tr>";
                $position++;
            }
...
<form action="submit_p6_report.php" method="post">
