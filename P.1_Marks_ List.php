            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='action-buttons'>
                            <a href='delet_p_1.php?id={$row['id']}' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                            <a href='Updatep_1_form.php?id={$row['id']}'>Update</a>
                        </td>
                      </tr>";
                $position++;
            }
...
<form action="submit_p1_report.php" method="post">
